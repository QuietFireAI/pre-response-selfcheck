...
3. **Do not reread what they wrote before shipping it** (after-turn addresses this)

---

## What after-turn Is

`after-turn` is a second-pass reader-shift protocol.
...
This is the most important architectural fact about after-turn.
...
| after-turn reader-shift | 5-10% | High -- same quality signal, fraction of the cost |
...
after-turn    <- runs AFTER response, reads as cold reader
               "Does what I just said read the way I intended to someone outside my frame?"
```

They are bookends. before-turn opens the turn. after-turn closes it.
...
after-turn is not a novel AI capability. It is the third-grade rule, applied
...
after-turn makes it a task. Unconditional. Every turn.
...
- after-turn closes with "did the response address it as intended"
